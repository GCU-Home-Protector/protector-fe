...
class HomePage extends StatefulWidget {
  ...
  HomePage({required this.initInx,});
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            ...
            // 클릭 시 색상 변경 설정
            color: _curInx == 0 ? Color.fromARGB(255, 9, 149, 14) : Colors.grey),
            label: '리스트',
          ),
            // 2. 카메라 
          BottomNavigationBarItem(
            ...
            // 클릭 시 색상 변경 설정
            color: _curInx == 1 ? Color.fromARGB(255, 9, 149, 14) : Colors.grey),
            label: '촬영',
          ),
            // 3. 설정 페이지
          BottomNavigationBarItem(
            ...
            // 클릭 시 색상 변경 설정
            color: _curInx == 2 ? Color.fromARGB(255, 9, 149, 14) : Colors.grey),
            label: '설정',
          ),
        ],
      ),
